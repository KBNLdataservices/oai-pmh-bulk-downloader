...
public interface RepositoryDao {
    ...
    @SqlUpdate("insert into repositories (name, url, metadataPrefix, oai_set, datestamp, schedule, stylesheet_id) " +
            "values (:name, :url, :metadataPrefix, :set, :dateStamp, :scheduleCode, :stylesheetId)")
